...
int main() {
	...
	graph.addEdge(cities["San Francisico"],cities["Los Angeles"], 381);

	graph.addEdge(cities["Seattle"],cities["Denver"], 1331);
	graph.addEdge(cities["Seattle"],cities["San Francisico"], 807);

	graph.addEdge(cities["Denver"],cities["Chicago"], 1003);
	graph.addEdge(cities["Denver"],cities["San Francisico"], 1267);

	graph.addEdge(cities["Chicago"],cities["Seattle"], 2097);
	graph.addEdge(cities["Chicago"],cities["Boston"], 983);
	
	graph.addEdge(cities["New York"],cities["Chicago"], 787);
	graph.addEdge(cities["New York"],cities["Atlanta"], 888);

	graph.addEdge(cities["Dallas"],cities["Kansas City"], 496);
	graph.addEdge(cities["Dallas"],cities["Atlanta"], 781);
	graph.addEdge(cities["Dallas"],cities["Los Angeles"], 1435);

	graph.addEdge(cities["Kansas City"],cities["Atlanta"], 864);
	graph.addEdge(cities["Kansas City"],cities["New York"], 1260);
	graph.addEdge(cities["Kansas City"],cities["Chicago"], 533);
	graph.addEdge(cities["Kansas City"],cities["Denver"], 599);
	graph.addEdge(cities["Kansas City"],cities["Los Angeles"], 1663);

	graph.addEdge(cities["Houston"],cities["Dallas"], 239);
	graph.addEdge(cities["Houston"],cities["Atlanta"], 810);

	graph.addEdge(cities["Miami"], cities["Houston"], 1187);

	graph.addEdge(cities["Atlanta"],cities["Miami"], 661);
